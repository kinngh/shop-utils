...
// Types for CHECKOUT_AND_ACCOUNTS_CONFIGURATIONS_UPDATE
export interface CHECKOUT_AND_ACCOUNTS_CONFIGURATIONS_UPDATE {
  admin_graphql_api_id: string;
  name: string;
  created_at: string;
  edited_at: string;
  ...
  settings: { typ_osp_pages_enabled: boolean };
}
