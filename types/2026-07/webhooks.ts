...
export interface RETURNS_APPROVE {
  ...
  name: null | string;
  return_line_items: any[];
  return_shipping_fees: {  id: number;
  admin_graphql_api_id: string;
  price: {  shop_money: {  amount: string;
...
// Types for INVENTORY_TRANSFERS_CANCEL
export interface INVENTORY_TRANSFERS_CANCEL {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
...
export interface PAYMENT_TERMS_UPDATE {
  ...
  created_at: string;
  updated_at: string;
  payment_schedules: {  amount: string;
  balance_due: string;
  completed_at: string;
  created_at: string;
  currency: string;
...
// Types for FULFILLMENT_ORDERS_MANUALLY_REPORTED_PROGRESS_STOPPED
export interface FULFILLMENT_ORDERS_MANUALLY_REPORTED_PROGRESS_STOPPED {
  fulfillment_order: {  id: string;
  status: string;
};
  progress_stopped_by_app: {  id: string;
};
  progress_stopped_by_user: {  id: string;
};
}

// Types for INVENTORY_TRANSFERS_UPDATED
export interface INVENTORY_TRANSFERS_UPDATED {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
...
export interface CHECKOUTS_CREATE {
  ...
  line_items: {  applied_discounts: any[];
  ...
  vendor: string;
  user_id: null | string;
  unit_price_measurement: {  measured_type: null | string;
  ...
  tax_exemptions: any[];
  admin_graphql_api_id: string;
  default_address: {  id: null | string;
  customer_id: number;
  first_name: string;
  last_name: string;
  company: null | string;
...
export interface ORDERS_PAID {
  ...
  created_at: string;
  currency: string;
  current_shipping_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  current_total_discounts_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  source_url: null | string;
  subtotal_price: string;
  subtotal_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  test: boolean;
  token: string;
  total_cash_rounding_payment_adjustment_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  total_cash_rounding_refund_adjustment_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  total_line_items_price: string;
  total_line_items_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  quantity: number;
  requires_shipping: boolean;
  sales_line_item_group_id: null | string;
  sku: string;
  taxable: boolean;
  title: string;
  total_discount: string;
  total_discount_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  shipping_lines: {  id: number;
  carrier_identifier: null | string;
  code: null | string;
  current_discounted_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
...
export interface CUSTOMER_PAYMENT_METHODS_CREATE {
  ...
  payment_instrument: {  last_digits: string;
  month: number;
  year: number;
  name: string;
  brand: string;
...
export interface SUBSCRIPTION_CONTRACTS_PAUSE {
  admin_graphql_api_id: string;
  id: number;
  billing_policy: {  interval: string;
  ...
  customer_id: number;
  admin_graphql_api_customer_id: string;
  delivery_policy: {  interval: string;
  interval_count: number;
};
  status: string;
...
// Types for INVENTORY_TRANSFERS_UPDATE_ITEM_QUANTITIES
export interface INVENTORY_TRANSFERS_UPDATE_ITEM_QUANTITIES {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
  ...
  status: string;
  items_updated: {  line_item_id: string;
  old_quantity: number;
  new_quantity: number;
}[];
}
...
export interface ORDERS_EDITED {
  ...
  staff_note: string;
  user_id: null | string;
  line_items: {  additions: {  id: number;
  delta: number;
}[];
  removals: {  id: number;
  delta: number;
  ...
  discounts: {  line_item: {  additions: any[];
  removals: any[];
};
};
  shipping_lines: {  additions: any[];
  removals: any[];
};
};
}

// Types for FINANCE_APP_STAFF_MEMBER_UPDATE
export interface FINANCE_APP_STAFF_MEMBER_UPDATE {
}
...
// Types for INVENTORY_SHIPMENTS_DELETE
export interface INVENTORY_SHIPMENTS_DELETE {
  id: string;
  happened_at: string;
}
...
export interface COMPANY_LOCATIONS_DELETE {
  ...
  tax_settings: {  tax_registration_id: string;
  tax_exempt: null | string;
  tax_exemptions: string[];
};
  company: {  name: string;
  note: string;
...
// Types for SHIPPING_ADDRESSES_CREATE
export interface SHIPPING_ADDRESSES_CREATE {
}
...
// Types for FULFILLMENT_HOLDS_RELEASED
export interface FULFILLMENT_HOLDS_RELEASED {
  fulfillment_order: {  id: string;
};
  fulfillment_hold: {  id: string;
  reason: string;
  reason_notes: string;
  held_by_requesting_app: boolean;
  handle: string;
  held_by_app: {  id: string;
};
};
}
...
export interface FULFILLMENT_ORDERS_SPLIT {
  split_line_items: {  id: string;
  quantity: number;
}[];
  fulfillment_order: {  id: string;
  status: string;
};
  remaining_fulfillment_order: {  id: string;
  status: string;
};
  replacement_fulfillment_order: {  id: string;
  status: string;
};
}

// Types for INVENTORY_TRANSFERS_ADD_ITEMS
export interface INVENTORY_TRANSFERS_ADD_ITEMS {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
  ...
  items_added: {  line_item_id: string;
  quantity: number;
}[];
}
...
export interface COMPANY_CONTACT_ROLES_ASSIGN {
  company_contact: {  customer_admin_graphql_api_id: string;
  title: string;
  locale: string;
  created_at: string;
  updated_at: string;
...
// Types for METAFIELD_DEFINITIONS_DELETE
export interface METAFIELD_DEFINITIONS_DELETE {
  id: string;
  type: string;
  created_by_app_id: null | string;
}
...
// Types for APP_SCOPES_UPDATE
export interface APP_SCOPES_UPDATE {
  id: number;
  shop_id: string;
  previous: string[];
  current: string[];
...
export interface DRAFT_ORDERS_CREATE {
  ...
  invoice_url: string;
  created_on_api_version_handle: null | string;
  applied_discount: {  description: string;
  value: string;
  title: string;
  amount: string;
  value_type: string;
  ...
  subtotal_price: string;
  total_tax: string;
  payment_terms: {  id: number;
  payment_terms_name: string;
  payment_terms_type: string;
  due_in_days: number;
  created_at: string;
  updated_at: string;
  payment_schedules: {  id: number;
  created_at: string;
  updated_at: string;
  payment_terms_id: number;
  reference_id: number;
...
export interface DOMAINS_DESTROY {
  ...
  host: string;
  ssl_enabled: boolean;
  localization: {  country: null | string;
...
export interface FULFILLMENT_ORDERS_MOVED {
  original_fulfillment_order: {  id: string;
  status: string;
  assigned_location_id: string;
};
  moved_fulfillment_order: {  id: string;
  status: string;
  assigned_location_id: string;
};
  destination_location_id: string;
  fulfillment_order_line_items_requested: {  id: string;
  quantity: number;
}[];
...
export interface APP_SUBSCRIPTIONS_APPROACHING_CAPPED_AMOUNT {
  app_subscription: {  admin_graphql_api_id: string;
  name: string;
  balance_used: number;
...
// Types for INVENTORY_SHIPMENTS_MARK_IN_TRANSIT
export interface INVENTORY_SHIPMENTS_MARK_IN_TRANSIT {
  id: string;
  status: string;
  happened_at: string;
}
...
export interface ORDER_TRANSACTIONS_CREATE {
  ...
  source_name: string;
  payment_details: {  credit_card_bin: null | string;
  ...
  currency: string;
  payment_id: string;
  total_unsettled_set: {  presentment_money: {  amount: string;
  currency: string;
};
...
export interface FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_SUBMITTED {
  ...
  submitted_fulfillment_order: {  id: string;
  status: string;
  request_status: string;
};
  fulfillment_order_merchant_request: {  id: string;
  message: string;
};
}
...
export interface SCHEDULED_PRODUCT_LISTINGS_ADD {
  ...
  variants: {  id: number;
  title: string;
  option_values: {  option_id: number;
  name: string;
  value: string;
}[];
  price: string;
...
export interface REVERSE_FULFILLMENT_ORDERS_DISPOSE {
  id: number;
  admin_graphql_api_id: string;
  dispositions: {  reverse_fulfillment_order_line_item: {  id: number;
  admin_graphql_api_id: string;
};
...
// Types for INVENTORY_TRANSFERS_COMPLETE
export interface INVENTORY_TRANSFERS_COMPLETE {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
...
// Types for SHIPPING_ADDRESSES_UPDATE
export interface SHIPPING_ADDRESSES_UPDATE {
}
...
// Types for INVENTORY_SHIPMENTS_UPDATE_TRACKING
export interface INVENTORY_SHIPMENTS_UPDATE_TRACKING {
  shipment_id: string;
  updated_tracking: {  tracking_number: string;
  tracking_url: string;
  company: string;
  arrives_at: string;
};
...
export interface REFUNDS_CREATE {
  ...
  processed_at: string;
  duties: any[];
  total_duties_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
...
export interface PRODUCTS_UPDATE {
  ...
  published_scope: string;
  tags: string;
  variants: {  admin_graphql_api_id: string;
  barcode: null | string;
  compare_at_price: string;
  created_at: string;
  id: number;
  ...
  image: null | string;
  media: any[];
  variant_gids: {  admin_graphql_api_id: string;
  updated_at: string;
}[];
...
// Types for ORDERS_LINK_REQUESTED
export interface ORDERS_LINK_REQUESTED {
  id: number;
  admin_graphql_api_id: string;
  app_id: null | string;
  browser_ip: null | string;
...
// Types for INVENTORY_TRANSFERS_REMOVE_ITEMS
export interface INVENTORY_TRANSFERS_REMOVE_ITEMS {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
  ...
  items_removed: {  line_item_id: string;
}[];
}

// Types for TAX_SERVICES_CREATE
export interface TAX_SERVICES_CREATE {
  id: number;
  name: string;
  url: string;
  active: boolean;
...
// Types for INVENTORY_SHIPMENTS_REMOVE_ITEMS
export interface INVENTORY_SHIPMENTS_REMOVE_ITEMS {
  id: string;
  items_removed: {  id: string;
}[];
  happened_at: string;
}
...
// Types for CUSTOMER_LEFT_SEGMENT
export interface CUSTOMER_LEFT_SEGMENT {
  shop_id: string;
  customer_id: string;
  segment_id: string;
}
...
// Types for MARKETS_BACKUP_REGION_UPDATE
export interface MARKETS_BACKUP_REGION_UPDATE {
  admin_graphql_api_id: string;
  code: string;
}
...
// Types for DELIVERY_PROMISE_SETTINGS_UPDATE
export interface DELIVERY_PROMISE_SETTINGS_UPDATE {
  shop_id: string;
  processing_time: string;
  delivery_dates_enabled: boolean;
}
...
// Types for METAFIELD_DEFINITIONS_CREATE
export interface METAFIELD_DEFINITIONS_CREATE {
  id: null | string;
  shop_id: number;
  namespace: string;
  key: string;
  ...
  standard_template_id: null | string;
  merchant_writeable: null | string;
  storefront_readable: null | string;
  customer_access: null | string;
  namespace_owner_api_client_id: null | string;
  unique_values: boolean;
  smart_collection_condition: boolean;
  option_linkable: boolean;
  admin_filterable: boolean;
  admin_filterable_status: null | string;
  app_config_managed: boolean;
  access_only: boolean;
  admin_filter_status: string;
...
export interface CARTS_UPDATE {
  ...
  line_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  original_line_price_set: {  shop_money: {  amount: string;
  currency_code: string;
};
  presentment_money: {  amount: string;
  currency_code: string;
  ...
  parent_relationship: null | string;
}[];
  note: null | string;
  updated_at: string;
  created_at: string;
...
// Types for FULFILLMENT_HOLDS_ADDED
export interface FULFILLMENT_HOLDS_ADDED {
  fulfillment_order: {  id: string;
};
  fulfillment_hold: {  id: string;
  reason: string;
...
// Types for INVENTORY_SHIPMENTS_CREATE
export interface INVENTORY_SHIPMENTS_CREATE {
  id: string;
  status: string;
  happened_at: string;
  tracking: {  arrives_at: string;
  tracking_number: string;
  tracking_url: string;
  company: string;
};
...
// Types for CUSTOMERS_WHATS_APP_MARKETING_CONSENT_UPDATE
export interface CUSTOMERS_WHATS_APP_MARKETING_CONSENT_UPDATE {
  customer_id: number;
  phone_number: null | string;
  whats_app_marketing_consent: {  state: null | string;
  opt_in_level: null | string;
  updated_at: null | string;
...
export interface FULFILLMENT_ORDERS_PLACED_ON_HOLD {
  ...
  held_fulfillment_order_line_items: {  id: string;
  quantity: number;
}[];
  created_fulfillment_hold: {  id: string;
  reason: string;
  reason_notes: string;
  held_by_requesting_app: boolean;
  handle: string;
...
// Types for INVENTORY_SHIPMENTS_RECEIVE_ITEMS
export interface INVENTORY_SHIPMENTS_RECEIVE_ITEMS {
  id: string;
  status: string;
  items_received: {  id: string;
  old_accepted_quantity: number;
  old_rejected_quantity: number;
  new_accepted_quantity: number;
  new_rejected_quantity: number;
...
export interface REVERSE_DELIVERIES_ATTACH_DELIVERABLE {
  ...
  shipping_deliverable: {  tracking: {  carrier_name: string;
  tracking_number: string;
  tracking_url: null | string;
};
  label: {  public_file_url: null | string;
  created_at: null | string;
};
};
}
...
// Types for INVENTORY_SHIPMENTS_ADD_ITEMS
export interface INVENTORY_SHIPMENTS_ADD_ITEMS {
  id: string;
  items_added: {  id: string;
  quantity: number;
}[];
  happened_at: string;
}
...
// Types for INVENTORY_TRANSFERS_READY_TO_SHIP
export interface INVENTORY_TRANSFERS_READY_TO_SHIP {
  id: string;
  happened_at: string;
  origin: {  id: string;
};
...
// Types for TAX_SERVICES_UPDATE
export interface TAX_SERVICES_UPDATE {
  id: number;
  name: string;
  url: string;
  active: boolean;
...
// Types for INVENTORY_SHIPMENTS_UPDATE_ITEM_QUANTITIES
export interface INVENTORY_SHIPMENTS_UPDATE_ITEM_QUANTITIES {
  id: string;
  items_updated: {  id: string;
  old_quantity: number;
  new_quantity: number;
}[];
  happened_at: string;
...
// Types for FINANCE_APP_STAFF_MEMBER_REVOKE
export interface FINANCE_APP_STAFF_MEMBER_REVOKE {
}
...
// Types for FINANCE_APP_STAFF_MEMBER_DELETE
export interface FINANCE_APP_STAFF_MEMBER_DELETE {
}

// Types for CUSTOMER_JOINED_SEGMENT
export interface CUSTOMER_JOINED_SEGMENT {
  shop_id: string;
  customer_id: string;
  segment_id: string;
}
...
// Types for FINANCE_APP_STAFF_MEMBER_GRANT
export interface FINANCE_APP_STAFF_MEMBER_GRANT {
}

// Types for AUDIT_EVENTS_ADMIN_API_ACTIVITY
export interface AUDIT_EVENTS_ADMIN_API_ACTIVITY {
  events: {  time: number;
  event: {  context: {  context_type: string;
  context_identifier: string;
  context_metadata: {  client_ip: string;
  content_type: string;
  ...
  actor_metadata: {  app_name: string;
  ...
  timestamp: string;
  additional_metadata: {  request_type: string;
  mutation_names: any[];
  query: string;
...
export interface RETURNS_UPDATE {
  admin_graphql_api_id: string;
  return_line_items: {  removals: {  admin_graphql_api_id: string;
  delta: number;
}[];
};
  restocking_fees: {  updates: any[];
  removals: any[];
};
  return_shipping_fees: {  updates: any[];
  removals: any[];
};
}
...
// Types for METAFIELD_DEFINITIONS_UPDATE
export interface METAFIELD_DEFINITIONS_UPDATE {
  id: null | string;
  shop_id: number;
  namespace: string;
  key: string;
...
// Types for RETURNS_PROCESS
export interface RETURNS_PROCESS {
}
...
// Types for FULFILLMENT_ORDERS_PROGRESS_REPORTED
export interface FULFILLMENT_ORDERS_PROGRESS_REPORTED {
  fulfillment_order: {  id: string;
  status: string;
};
  progress_report: {  reason_notes: string;
  progress_reported_by_app: {  id: string;
};
  progress_reported_by_user: {  id: string;
};
};
...
// Types for LOCALES_DESTROY
export interface LOCALES_DESTROY {
  locale: string;
  published: boolean;
}
...
// Types for CUSTOMERS_PURCHASING_SUMMARY
export interface CUSTOMERS_PURCHASING_SUMMARY {
  customerId: string;
...
export interface CUSTOMERS_MARKETING_CONSENT_UPDATE {
  id: number;
  phone: null | string;
  sms_marketing_consent: {  state: null | string;
  opt_in_level: null | string;
  consent_updated_at: null | string;
...
// Types for FINANCE_KYC_INFORMATION_UPDATE
export interface FINANCE_KYC_INFORMATION_UPDATE {
}

// Types for FULFILLMENT_ORDERS_MERGED
export interface FULFILLMENT_ORDERS_MERGED {
  merge_intents: {  fulfillment_order_id: number;
  fulfillment_order_line_items: {  id: number;
  quantity: number;
}[];
}[];
  fulfillment_order_merges: {  fulfillment_order: {  id: string;
  status: string;
};
};
}
