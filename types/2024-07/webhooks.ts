...
// Types for ATTRIBUTED_SESSIONS_LAST
export interface ATTRIBUTED_SESSIONS_LAST {}
...
export interface FULFILLMENT_ORDERS_PLACED_ON_HOLD {
  fulfillment_order: {
    id: string;
    status: string;
    fulfillment_holds: { id: string; reason: string; reason_notes: string }[];
  };
  remaining_fulfillment_order: { id: string; status: string };
...
// Types for ATTRIBUTED_SESSIONS_FIRST
export interface ATTRIBUTED_SESSIONS_FIRST {}
