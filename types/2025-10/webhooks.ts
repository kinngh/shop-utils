...
export interface INVENTORY_TRANSFERS_ADD_ITEMS {
  id: string;
  items_added: { line_item_id: string; quantity: number }[];
  happened_at: string;
}
...
export interface INVENTORY_SHIPMENTS_ADD_ITEMS {
  id: string;
  items_added: { id: string; quantity: number }[];
  happened_at: string;
}
...
export interface INVENTORY_SHIPMENTS_UPDATE_ITEM_QUANTITIES {
  id: string;
  items_updated: { id: string; old_quantity: number; new_quantity: number }[];
  happened_at: string;
}
